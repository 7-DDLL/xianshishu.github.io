...
window.onload = function () {
	...
	if(oDt.getHours()>3&&oDt.getHours()<=6)
        period+="凌晨好！"
    else if(oDt.getHours()>6&&oDt.getHours()<=8)
        period+="早晨好！"
    else if(oDt.getHours()>8&&oDt.getHours()<=11)
        period+="上午好！"
    else if(oDt.getHours()>11&&oDt.getHours()<=13)
        period+="中午好！"
    else if(oDt.getHours()>13&&oDt.getHours()<=17)
        period+="下午好！"
    else if(oDt.getHours()>17&&oDt.getHours()<19)
        period+="傍晚好！"
    else if(oDt.getHours()>=19&&oDt.getHours()<=23)
        period+="晚上好！"
    else
        period+="深夜好！"
    ...
    document.getElementById("date").innerHTML ="<span>"+period+"<span>" + "<span>" + oDt.getFullYear() + "年" + iMonth + "月" + oDt.getDate() + "日 " + sWd + "</span>";
